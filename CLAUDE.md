...
# Personal activity (Gerrit + Launchpad)
ptl --gerrit-user gthiemon --lp-user gthiemonge -d 7
...
| `ptl_agent/fetch_launchpad_activity.py` | Launchpad (api.launchpad.net) | Fetches personal bug activity: reported and assigned bugs |
